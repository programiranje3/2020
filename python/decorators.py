...
def members(f_to_decorate):
    ...
    def decorator(*args, **kwargs):
        ...
        print("members:", ', '.join([a for a in args[1:] if args]))
...
if __name__ == '__main__':
    ...
    # print(return_function(john, 'f')())

    # print(return_function_with_args(1)(john, 'Liverpool'))
    # print(return_function_with_args()(john, 'Liverpool'))
    ...
    # # print()
    # #
    # # # f = a_very_simple_decorator(something)
    # # # f(john)
    # #
    ...
    print_band('The Beatles', *the_beatles, formed=1962, split_up=1970)
    print()

    print(print_band.__name__)
    print(print_band.__doc__)
